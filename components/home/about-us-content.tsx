...
const stats = [
  { value: "10K+", label: "Workflows automated" },
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {stats.map((stat) => (
              <div
                ...
                <p className="mt-2 text-sm text-[#333333]d">{stat.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-base leading-relaxed text-foreground sm:text-lg">
              Our founders spent years watching talented teams drown in repetitive
              tasks — copying data between tools, triggering alerts manually, and
              waiting on engineering for every small automation. Avispark started
              as an internal tool and grew into a platform used by hundreds of teams
              to reclaim their time and focus on high-impact work.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-surface-elevated py-16 lg:py-20">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          ...
          <p className="mt-4 text-base text-foreground sm:text-lg">
            Join hundreds of teams already using Avispark to build smarter, faster
            automations.
          </p>
