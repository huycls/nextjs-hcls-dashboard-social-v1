        ...
        <div className="absolute left-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-xl border border-border bg-surface p-1.5 shadow-lg">
          {items.map((item) => (
            <Link
              ...
              className="block rounded-lg group px-3 py-2.5 transition hover:bg-primary/10">
              <span className="text-sm transition-all duration-150 ease-in-out font-medium text-heading group-hover:text-primary">
                {item.label}
              </span>
              {item.description && (
